...
<li><a href="nacc.php">Open New Account</a></li>
  ...
  <li><a class="active" href="aadhar.php">Aadhar Link</a></li>
  <li><a href="settings.php">Settings</a></li>
</ul>
<div id="demo">
<h2><u>Aadhar Number Link</u></h2></br>
<div class="container">
<form method="POST" action="aadharsave.php">
 ...
 <input maxlength="16" type="text" placeholder="Aadhar Number" name="anum" required></br>

 <button type="submit">Link</button></br></div>
 <a href="nacc.html" ><button type="cancel">Cancel</button></a></br></div>
 </div>
 </form>
 <?php
   if($_GET)
