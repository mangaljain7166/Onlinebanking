...
<div class="container">
<form method="POST" action="changesave.php">
 <label><b>Current Password</b></label></br>
 <input maxlength="6" type="password" placeholder="Enter Old Password" name="opass" required></br>
 
 <label><b>New Password</b></label></br>
 <input maxlength="6" type="password" placeholder="Enter New Password" name="npass" required></br>
 <label><b>Confirm Password</b></label></br>
 <input maxlength="6" type="password" placeholder="Enter Confirm Password" name="cpass" required></br>
 <button type="submit">Change</button></br></div>
