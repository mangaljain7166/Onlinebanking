...
<li><a href="nacc.php">Open New Account</a></li>
  ...
  <li><a class="active" href="moneytransfer.php">Money Transfer</a></li>
...
<div id="demo">
<h2><u>Transfer Money</u></h2></br>
<div class="container">
<form method="POST" action="transaction.php">
  
 <label><b>From Account Number</b></label></br>
 <input maxlength="11" type="text" placeholder="Enter Account Number" name="fromacnum" required></br>
 
 <label><b>To Account Number</b></label></br>
 <input maxlength="11" type="text" placeholder="Enter Account Number" name="toacnum" required></br>

 
 <label><b>Amount</b></label></br>
 <input type="text" placeholder="Enter Amount" name="amt" required></br>
 
 <button type="submit">Transfer</button></br></div>
